package com.wutos.base.common.pdf.factory;
...
public class ITextRendererObjectFactory extends
    ...
    public static ITextFontResolver addFonts(ITextFontResolver fontResolver)
        ...
        InputStream resourceAsStream = ITextRendererObjectFactory.class.getResourceAsStream("/config/fonts/ARIALUNI.TTF");

        File fontsDir = new File(System.getProperty("user.home")+"/ARIALUNI.TTF");
        OutputStream out = new FileOutputStream(fontsDir);
        IOUtils.copy(resourceAsStream,out);
        resourceAsStream.close();
        out.close();
        fontResolver.addFont(fontsDir.getAbsolutePath(), BaseFont.IDENTITY_H,
