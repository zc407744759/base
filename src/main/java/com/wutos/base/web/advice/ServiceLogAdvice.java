...
public class ServiceLogAdvice {
    private final static Logger logger = LoggerFactory.getLogger(ServiceLogAdvice.class);
     ...
     */
    @Pointcut("execution(public * com.wutos.SecurityPrevention.service.impl.*.*(..))")
